...
let responseData;
let DB_NAME = "couriermanagementsystem";
let COLLECTION_NAME = "couriermanagementsystem"
async function main() {
    const uri = `mongodb+srv://nikitharaavi801:nikitha@cluster0.udmdm6r.mongodb.net/${DB_NAME}?retryWrites=true&w=majority`;
